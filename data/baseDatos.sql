...
-- -----------------------------------------------------
-- Schema ConsejosComunales
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `ConsejosComunales` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `ConsejosComunales` ;

-- -----------------------------------------------------
-- Table `ConsejosComunales`.`EstadosVenezuela`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ConsejosComunales`.`EstadosVenezuela` (
  `idEstadosVenezuela` INT NOT NULL AUTO_INCREMENT,
  `descripcionEstados` VARCHAR(30) NOT NULL,
  PRIMARY KEY (`idEstadosVenezuela`))
ENGINE = InnoDB;

INSERT INTO `EstadosVenezuela` (`idEstadosVenezuela`, `descripcionEstados`) VALUES
(1, 'Amazonas'),
(2, 'Anzoátegui'),
(3, 'Apure'),
(4, 'Aragua'),
...
-- -----------------------------------------------------
-- Table `ConsejosComunales`.`Municipios`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ConsejosComunales`.`Municipios` (
  `idMunicipios` INT NOT NULL AUTO_INCREMENT,
  `nombreMunicipios` VARCHAR(60) NOT NULL,
  `Estados_idEstados` INT NOT NULL,
  PRIMARY KEY (`idMunicipios`),
  INDEX `fk_Municipios_Estados1_idx` (`Estados_idEstados` ASC),
  CONSTRAINT `fk_Municipios_Estados1`
    FOREIGN KEY (`Estados_idEstados`)
    REFERENCES `ConsejosComunales`.`EstadosVenezuela` (`idEstadosVenezuela`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

INSERT INTO `Municipios` (`idMunicipios`, `Estados_idEstados`, `nombreMunicipios`) VALUES
(1, 1, 'Alto Orinoco'),
(2, 1, 'Atabapo'),
(3, 1, 'Atures'),
(4, 1, 'Autana'),
...
-- -----------------------------------------------------
-- Table `ConsejosComunales`.`Parroquias`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ConsejosComunales`.`Parroquias` (
  `idParroquias` INT NOT NULL AUTO_INCREMENT,
  `NombreParroquia` VARCHAR(60) NOT NULL,
  `Municipios_idMunicipios` INT NOT NULL,
  PRIMARY KEY (`idParroquias`),
  INDEX `fk_Parroquias_Municipios1_idx` (`Municipios_idMunicipios` ASC),
  CONSTRAINT `fk_Parroquias_Municipios1`
    FOREIGN KEY (`Municipios_idMunicipios`)
    REFERENCES `ConsejosComunales`.`Municipios` (`idMunicipios`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;


INSERT INTO `Parroquias` (`idParroquias`, `Municipios_idMunicipios`, `NombreParroquia`) VALUES
(1, 1, 'Alto Orinoco'),
...
(827, 345, 'Cárdenas'),
(828, 345, 'Amenodoro Rangel Lamus'),
(829, 345, 'La Florida'),
(830, 346, 'Córdoba'),
...
-- -----------------------------------------------------
-- Table `ConsejosComunales`.`ConsejoComunal`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ConsejosComunales`.`ConsejoComunal` (
  `idConsejoComunal` INT NOT NULL AUTO_INCREMENT,
  `NombreConsejoComunal` VARCHAR(50) NOT NULL,
  `fechaInscripcionConsejoComunal` DATE NOT NULL,
  `Parroquias_idParroquias` INT NOT NULL,
  PRIMARY KEY (`idConsejoComunal`),
  INDEX `fk_ConsejoComunal_Parroquias1_idx` (`Parroquias_idParroquias` ASC),
  CONSTRAINT `fk_ConsejoComunal_Parroquias1`
    FOREIGN KEY (`Parroquias_idParroquias`)
    REFERENCES `ConsejosComunales`.`Parroquias` (`idParroquias`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ConsejosComunales`.`TipoIdentificacion` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ConsejosComunales`.`NivelInstruccion` (
  `idNivelInstruccion` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ConsejosComunales`.`EstadosCiviles` (
  `idEstadosCiviles` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ConsejosComunales`.`Cargo` (
...
-- -----------------------------------------------------
-- Table `ConsejosComunales`.`Persona`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ConsejosComunales`.`Persona` (
  `cedulaPersona` INT NOT NULL AUTO_INCREMENT,
  `primerNombre` VARCHAR(30) NOT NULL,
  `segundoNombre` VARCHAR(30) NULL,
  `primerApellido` VARCHAR(30) NOT NULL,
  `segundoApelllido` VARCHAR(30) NULL,
  ...
  `NivelInstruccion_idNivelInstruccion` INT NOT NULL,
  ...
  INDEX `fk_Persona_EstadosCiviles1_idx` (`EstadosCiviles_idEstadosCiviles` ASC),
  INDEX `fk_Persona_Cargo1_idx` (`Cargo_idCargo` ASC),
  INDEX `fk_Persona_ConsejoComunal1_idx` (`ConsejoComunal_idConsejoComunal` ASC),
  INDEX `fk_Persona_Persona1_idx` (`Persona_cedulaPersona` ASC),
  CONSTRAINT `fk_Persona_TipoIdentificacion`
    FOREIGN KEY (`TipoIdentificacion_idTipoIdentificacion`)
    REFERENCES `ConsejosComunales`.`TipoIdentificacion` (`idTipoIdentificacion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Persona_NivelInstruccion1`
    FOREIGN KEY (`NivelInstruccion_idNivelInstruccion`)
    REFERENCES `ConsejosComunales`.`NivelInstruccion` (`idNivelInstruccion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Persona_EstadosCiviles1`
    FOREIGN KEY (`EstadosCiviles_idEstadosCiviles`)
    REFERENCES `ConsejosComunales`.`EstadosCiviles` (`idEstadosCiviles`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Persona_Cargo1`
    FOREIGN KEY (`Cargo_idCargo`)
    REFERENCES `ConsejosComunales`.`Cargo` (`idCargo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Persona_ConsejoComunal1`
    FOREIGN KEY (`ConsejoComunal_idConsejoComunal`)
    REFERENCES `ConsejosComunales`.`ConsejoComunal` (`idConsejoComunal`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Persona_Persona1`
    FOREIGN KEY (`Persona_cedulaPersona`)
    REFERENCES `ConsejosComunales`.`Persona` (`cedulaPersona`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ConsejosComunales`.`TipoSolicitud` (
  `idTipoSolicitud` INT NOT NULL AUTO_INCREMENT,
  `descripcionTipoSolicitud` VARCHAR(50) NOT NULL,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ConsejosComunales`.`Solicitudes` (
  `idSolicitudes` INT NOT NULL AUTO_INCREMENT,
  `fechaRealizacion` DATE NOT NULL,
  `Persona_cedulaPersona` INT NOT NULL,
  `ConsejoComunal_idConsejoComunal` INT NOT NULL,
  `TipoSolicitud_idTipoSolicitud` INT NOT NULL,
  PRIMARY KEY (`idSolicitudes`),
  INDEX `fk_Solicitudes_Persona1_idx` (`Persona_cedulaPersona` ASC),
  INDEX `fk_Solicitudes_ConsejoComunal1_idx` (`ConsejoComunal_idConsejoComunal` ASC),
  INDEX `fk_Solicitudes_TipoSolicitud1_idx` (`TipoSolicitud_idTipoSolicitud` ASC),
  CONSTRAINT `fk_Solicitudes_Persona1`
    FOREIGN KEY (`Persona_cedulaPersona`)
    REFERENCES `ConsejosComunales`.`Persona` (`cedulaPersona`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Solicitudes_ConsejoComunal1`
    FOREIGN KEY (`ConsejoComunal_idConsejoComunal`)
    REFERENCES `ConsejosComunales`.`ConsejoComunal` (`idConsejoComunal`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Solicitudes_TipoSolicitud1`
    FOREIGN KEY (`TipoSolicitud_idTipoSolicitud`)
    REFERENCES `ConsejosComunales`.`TipoSolicitud` (`idTipoSolicitud`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ConsejosComunales`.`Estados` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ConsejosComunales`.`Estado_Solicitudes` (
  ...
  INDEX `fk_Estado_Solicitud_Solicitudes1_idx` (`Solicitudes_idSolicitudes` ASC),
  INDEX `fk_Estado_Solicitud_Estados1_idx` (`Estados_idEstados` ASC),
  CONSTRAINT `fk_Estado_Solicitud_Solicitudes1`
    FOREIGN KEY (`Solicitudes_idSolicitudes`)
    REFERENCES `ConsejosComunales`.`Solicitudes` (`idSolicitudes`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Estado_Solicitud_Estados1`
    FOREIGN KEY (`Estados_idEstados`)
    REFERENCES `ConsejosComunales`.`Estados` (`idEstados`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
