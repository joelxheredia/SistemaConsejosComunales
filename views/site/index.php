...
<div class="site-index" id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
    ...
    <div class="jumbotron text-center">
      ...
      <form class="form-inline">
        ...
        <a href="  <?php  echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/consejocomunal/listarconsejo " type="button" class="btn btn-danger">Buscar</a>
      </form>
    </div>
...
<div class="container-fluid bg-grey">
  <div class="row">
    ...
    <div class="col-sm-12">
      <h3>Pasos para conformar un nuevo Consejo Comunal</h3>
    ...
    <div class="col-sm-12">
      ...
      <a href="  <?php  echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/consejocomunal/create " type="button" class="btn btn-">Registrar</a>
      </div>
  </div>
</div>
...
<div id="services" class="container-fluid text-center">
  ...
  <div class="row "> <!--slideanim">-->
    <div class="col-sm-6 col-xs-12">
      <div class="panel panel-default text-center">    
        <div class="panel-body">
          <p><strong>Consulta </strong> por diversos criterios los miembros de tu Consejo Comunal</p>
        </div>
        <div class="panel-heading">
          <h1>Consulta</h1>
        </div>
    ...
    <div class="col-sm-6 col-xs-12">
      <div class="panel panel-default text-center">    
        <div class="panel-body">
          <p><strong>Genera </strong> el cuadero electoral y otros reportes de tu Consejo Comunal</p>
        </div>
        <div class="panel-heading">
          <h1>Genera</h1>
        </div>
...
<div id="portfolio" class="container-fluid text-center bg-grey">
  ...
  <div class="row text-center "> <!--slideanim"> -->
    <div class="col-sm-4">
      <div class="thumbnail">
        <p><strong>Busca tu Consejo Cocumal y registra a os miembros de tu familia</strong></p>
        <input type="email" class="form-control" size="50" placeholder="Buscar Consejo Comunal" required>
        <button class="btn btn-lg">Buscar</button>
        <br><br>

        <p>No conoce el nombre del Consejo Cocumal, realiza una busqueda por Estado, Municio o parroquia</p>
        <button class="btn btn-lg">Buscar</button>
    ...
    <div class="col-sm-4">
      <div class="thumbnail">        
        ...
        <img src="newyork.jpg" alt="Familia" width="400" height="300">
        <p>Si tu familia ya se encuentra registrada en el Consejo Comunal de tu comunidad</p>
    ...
    <div class="col-sm-4">
      <div class="thumbnail">        
        ...
        <img src="sanfran.jpg" alt="Registrar" width="400" height="300">
